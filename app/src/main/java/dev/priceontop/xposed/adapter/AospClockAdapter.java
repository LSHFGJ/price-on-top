...
public final class AospClockAdapter implements ClockTargetAdapter {
    private static final String ADAPTER_NAME = "aosp-clock";
    ...
    public boolean supportsRom(RomFamily romFamily) {
        return romFamily == RomFamily.AOSP_PIXEL_LINEAGE || romFamily == RomFamily.UNKNOWN || romFamily == null;
    }
    ...
    private boolean isSupportedClassName(String className) {
        ...
        return normalized.equals("com.android.systemui.statusbar.policy.clock")
            || normalized.equals("com.android.systemui.statusbar.phone.clock")
            || normalized.equals("com.android.systemui.statusbar.phone.phonestatusbarclock")
            || normalized.endsWith(".statusbar.policy.clock")
            || normalized.endsWith(".statusbar.phone.clock");
    }
